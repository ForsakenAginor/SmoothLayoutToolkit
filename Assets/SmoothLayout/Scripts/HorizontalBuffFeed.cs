...
{
    public class HorizontalBuffFeed : AbstractedFeed<HorizontalBuffIcon>, IBuffFeed
    {
        ...
        public void Show(string buffType, float duration)
        {
            ...
            HorizontalBuffIcon inactiveBuff = Messages.FirstOrDefault(message => message.IsDisplaying == false);
            ...
            {
                HorizontalBuffIcon newBuff = CreateMessage();
